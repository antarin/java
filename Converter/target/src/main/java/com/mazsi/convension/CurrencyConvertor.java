    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(com.mazsi.convension.CurrencyConvertor.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = com.mazsi.convension.CurrencyConvertor.class.getResource(".");
            url = new URL(baseUrl, "http://www.webservicex.com/CurrencyConvertor.asmx?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://www.webservicex.com/CurrencyConvertor.asmx?wsdl', retrying as a local file");
